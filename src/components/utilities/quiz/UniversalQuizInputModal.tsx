      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-purple-600 to-pink-500 text-white flex items-center justify-center shadow-md">
          ...
          {activeTab === 'image' && (
            <div className="space-y-3">
              ...
              <div
                ...
                className="p-6 border-2 border-dashed border-indigo-400/50 dark:border-indigo-600/50 rounded-xl bg-indigo-50/30 dark:bg-indigo-950/20 hover:bg-indigo-50/60 dark:hover:bg-indigo-950/40 text-center space-y-2 cursor-pointer transition"
              >
                <div className="w-12 h-12 rounded-xl bg-indigo-100 dark:bg-indigo-900/60 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mx-auto">
          ...
          {activeTab === 'file' && (
            <div className="space-y-3">
              ...
              <div
                ...
                className="p-6 border-2 border-dashed border-purple-400/50 dark:border-purple-600/50 rounded-xl bg-purple-50/30 dark:bg-purple-950/20 hover:bg-purple-50/60 dark:hover:bg-purple-950/40 text-center space-y-2 cursor-pointer transition"
              >
                <div className="w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-900/60 text-purple-600 dark:text-purple-400 flex items-center justify-center mx-auto">
