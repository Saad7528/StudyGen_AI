...
const SAMPLE_TOPICS: Record<string, StudySummaryResult> = {
  ...
  'islamic-tawheed': {
    title: 'তাওহীদ, রিসালাত ও আখিরাত (ঈমানের মূল বিষয়সমূহ)',
    topic: 'ইসলাম ও নৈতিক শিক্ষা',
    subject: 'ইসলামিক শিক্ষা',
    quickSummary: [
      'তাওহীদ হলো একত্ববাদ—আল্লাহ তায়ালাকে সত্তা, গুণাবলী ও ইবাদতে একক ও লা-শরীক হিসেবে বিশ্বাস করা।',
      'রিসালাত হলো আল্লাহর বাণী মানুষের কাছে পৌঁছে দেওয়ার পবিত্র দায়িত্ব। সর্বশেষ নবী হযরত মুহাম্মদ (সা.)।',
      'আখিরাত হলো মৃত্যুর পরবর্তী অনন্ত জীবনের প্রতি অবিচল বিশ্বাস (কবর, হাশর, মিজান, পুলসিরাত, জান্নাত ও জাহান্নাম)।',
      'শিরক হলো আল্লাহর সাথে অন্য কাউকে অংশীদার স্থাপন করা যা ক্ষমার অযোগ্য পাপ।'
    ],
    keyDefinitions: [
      {
        term: 'তাওহীদুল উলুহিয়্যাহ (Tawheed of Worship)',
        explanation: 'যাবতীয় ইবাদত (নামাজ, রোজা, দোয়া, কুরবানি) একমাত্র আল্লাহর উদ্দেশ্যেই সম্পাদন করা।'
      },
      {
        term: 'খাতামুন্নাবিয়্যীন (Seal of Prophets)',
        explanation: 'মহানবী হযরত মুহাম্মদ (সা.) হলেন নবুওয়াতের ধারাবাহিকতার সমাপ্তি ও শেষ নবী।'
      }
    ],
    formulasAndRules: [
      { label: 'কালিমায়ে তাইয়্যিবা', formula: '\\text{লা ইলাহা ইল্লাল্লাহু মুহাম্মাদুর রাসুলুল্লাহ}', note: 'আল্লাহ ছাড়া কোনো উপাস্য নেই, মুহাম্মদ (সা.) আল্লাহর রাসুল' }
    ],
    highYieldExamTips: [
      'তাওহীদের বিপরীত ধারণা হলো শিরক এবং নিফাক।',
      'আখিরাতে সর্বপ্রথম হিসাব নেওয়া হবে নামাজের।'
    ],
    sampleQuestions: [
      {
        question: 'তাওহীদ বিশ্বাসের বাস্তব প্রভাব কী?',
        answer: 'তাওহীদ মানুষকে কুসংস্কার ও অন্যের দাসত্ব থেকে মুক্ত করে আত্মমর্যাদা ও একনিষ্ঠতা দান করে।'
      }
    ],
    generatedAt: 'August 2026'
  }
    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-5 rounded-xl bg-white/70 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 backdrop-blur-xl shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-pink-500 via-rose-500 to-amber-500 p-0.5 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="h-9 px-3.5 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold flex items-center gap-1.5 transition cursor-pointer"
          >
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="h-9 px-4 rounded-lg bg-gradient-to-r from-pink-600 to-rose-600 hover:opacity-95 text-white text-xs font-bold shadow-md shadow-pink-500/20 flex items-center gap-1.5 transition cursor-pointer"
          >
      ...
      <div className="p-4 sm:p-5 rounded-xl bg-white/70 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 backdrop-blur-xl shadow-xs space-y-3.5">
        ...
        <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-slate-800">
          ...
          <textarea
            ...
            className="w-full p-3 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs sm:text-sm text-slate-900 dark:text-white focus:ring-2 focus:ring-pink-500"
          />
          <div className="flex justify-end">
            <button
              ...
              className="h-10 px-4 rounded-lg bg-pink-600 hover:bg-pink-700 text-white text-xs font-bold shadow-md flex items-center gap-1.5 transition disabled:opacity-50 cursor-pointer"
            >
              {isGenerating ? (
                <>
