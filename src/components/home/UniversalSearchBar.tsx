  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-4 pt-2">
      ...
      <div 
        ...
        className="group relative flex items-center gap-3 p-2 sm:p-2.5 rounded-xl bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 hover:border-indigo-500/60 dark:hover:border-indigo-500/60 shadow-lg shadow-indigo-500/5 backdrop-blur-xl transition-all duration-200 cursor-pointer"
      >
        <div className="w-10 h-10 rounded-lg bg-gradient-to-tr from-indigo-600 via-purple-600 to-pink-500 text-white flex items-center justify-center shadow-md shadow-indigo-500/20 shrink-0 group-hover:scale-105 transition-transform">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1 text-xs font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
            <Command className="w-3.5 h-3.5" /> K
          </span>
          <button
            type="button"
            className="h-9 px-4 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-md shadow-indigo-600/20 flex items-center gap-1.5 transition cursor-pointer"
          >
            <span>খুলুন</span>
      ...
      <div className="flex items-center justify-center flex-wrap gap-2 pt-1">
        ...
        {quickChips.map(chip => (
          <button
            ...
            className={`min-h-[36px] px-3.5 py-1.5 rounded-lg text-xs font-medium bg-white/70 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 backdrop-blur-md shadow-sm transition-all hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:shadow cursor-pointer ${chip.color}`}
          >
            {chip.label}
          </button>
        ))}
