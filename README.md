...
## 🚀 ফিচারসমূহ (Feature Matrix)
- **AI প্রশ্নপত্র তৈরি (CQ & MCQ)**: ছবি থেকে সরাসরি এডিটেবল ওয়ার্ড ডকক্স ফাইল তৈরি।
- **ওএমআর শিট জেনারেটর**: কাস্টমাইজড প্রিন্ট-রেডি OMR শিট।
- **মেমরি টেকনিক ও নেমোনিক ইঞ্জিন**: বিজ্ঞানসম্মত ছন্দ ও ভিজ্যুয়াল মেমরি কার্ড।
- **ব্যাকরণ ও বানান পরীক্ষক**: ১-ক্লিকে স্মার্ট ফিক্স।
- **গণিত ও সমীকরণ সমাধানকারী**: KaTeX স্টেপ-বাই-স্টেপ সমাধান।
- **টেক্সট ডিফারেন্স ফাইন্ডার**: পাশাপাশি সাইড-বাই-সাইড তুলনা।
